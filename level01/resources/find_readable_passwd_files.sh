...
# - the file is owned by the `level01` user
# - the file shares a group with the `level01` user and is group-readable
# - the file is other-readable
# and, for each file owned by the `level01` user, makes them user-readable
